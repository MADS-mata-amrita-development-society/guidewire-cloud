    ...
    <div className="login-page">
      <div className="login-card">
        <div className="login-brand">
          ...
          <p className="login-subtitle">Company Portal</p>
        </div>
        {error && (
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          <Input label="Email" type="email" placeholder="manager@company.com" value={email} onChange={e => setEmail(e.target.value)} icon={<Envelope size={16} />} required />
        ...
        <p className="login-footer-text">Protected by Aegis Insurance Systems</p>
      </div>
    </div>
  );
}
